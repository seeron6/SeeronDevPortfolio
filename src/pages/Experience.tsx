...
import { getExperience, type Role } from '../lib/experience';
...
export default function Experience() {
  ...
  return (
    <div className="mx-auto max-w-3xl px-6 pt-10 pb-4 md:pt-16">
      ...
      <div className="mt-16">
        {(roles ?? []).map((role, i) => (
          <Reveal key={role.id ?? role.company} delay={i * 60}>
            <div className="relative pb-14 pl-8" style={{ borderLeft: '1px solid var(--color-line)' }}>
              <span
