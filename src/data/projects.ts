...
export const projects: Project[] = [
  {
    ...
    highlights: [
      ...
      'Integrated Cloudinary for dynamic media optimization and delivery within the agentic workflow — high-performance asset handling for multi-modal reasoning results.',
    ],
  },
  {
    id: 'revenant',
  ...
  },
  {
    ...
    highlights: [
      'Built on Gemini 2.5 Flash — generates structured newcomer roadmaps from unstructured conversational input with persistent user context.',
